...
export default function SetupPopup(props: {stage: SetupStage | undefined, setNotifsStatus: (perm: NotificationPermission)=>void}) {
    ...
    return (
        <div className={"w-full h-full fixed top-0 " + (stage ? "opacity-100 visible transition-opacity duration-[0.3s]" : "opacity-0 invisible")} style={{background: "rgba(0, 0, 0, 0.5)", transition: !stage ? "" : "opacity 0.2s 0.1s, visibility 0.4s"}}>
